...
export default function BlogCard({ title, date, excerpt, slug, tags, isFavorited }: BlogCardProps) {
  return (
    <Link href={`/blog/${slug}`} className="card group relative block">
      {isFavorited && (
        <span className="absolute right-4 top-4 text-red-500" aria-label="Favorited">
